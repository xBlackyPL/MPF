...
//example function - genaralized Rosenbrock fuction. (FORTRAN, see func.f95)
extern float t_func_(float *x,int *n);

//usually unnecessary wrapper introduced here because library function "pso" needs "int" as a second argument (Fortran calls arguments are pointers)
...
nb=128; // number of particles cat 
